...
The goal of this project is to evaluate the effectiveness of AEX-Notify against single-stepping attackers.
To evaluate AEX-Notify, we first had to understand how it works.

\todo[inline]{Explain why we first looked into how AEX-Notify works and then
  transition into the structure of this section.}
