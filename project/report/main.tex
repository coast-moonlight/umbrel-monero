...
\begin{figure}[t]
  ...
  \caption{Implementation of an exponentiation function using square and multiply.
...
\begin{figure}[t]
  ...
  \caption{After resuming execution, the enclave has to lookup the pages for
