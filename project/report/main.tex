...
CopyCat is a framework that utilizes SGX-Step to extract control-flow information from SGX enclaves \cite{ArnautovTGKMPLM16}. By analyzing the timing of interrupts and observing enclave behavior, CopyCat can infer the control flow of enclave applications.
