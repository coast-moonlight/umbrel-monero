...
\lstdefinestyle{code}{
  ...
  classoffset=0,
  morecomment=[l]{\#},
  keywordstyle=\color{red!50!black!70},
  morekeywords={mov,movb,lfence,movl,shlx,jrcxz,lea,shrx,shlx,call,jmp,incl},
  classoffset=1,
  keywordstyle=\color{blue!50!black!70},
  morekeywords={ct_enable_aexnotify,__ct_mitigation_begin,ct_check_write,ct_clear_low_bits_of_rdx,ct_check_execute,ct_warm_caches_and_tlbs,ct_restore_stage,ct_restore_rcx,is_null_pointer},
}
