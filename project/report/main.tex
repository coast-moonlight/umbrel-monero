...
we enabled AEX-Notify for the enclave.
...
The analysis has lead us to one important question regarding the exception handler:
...
by using a page-fault on the code page.
...
\begin{itemize}
    \item Summary of key findings: No longer single-stepping, AEX-Notify seems sufficient to stop single-stepping attacks.
    \item Future research directions: Implementing proper attacks and testing if AEX-Notify still fulfills its objective
\end{itemize}
