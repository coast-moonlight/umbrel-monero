...
\todo{There should be some introductory text here. From the moodle: ``Never have two titles following each other.''}

\subsection{Intel SGX}

\todo[inline]{Explain the basics of SGX.}
\begin{itemize}
